...
class IkimonoRegisterForm extends ConsumerStatefulWidget {
  const IkimonoRegisterForm({
  ...
  @override
  ConsumerState<IkimonoRegisterForm> createState() =>
      _IkimonoRegisterFormState();
}

class _IkimonoRegisterFormState extends ConsumerState<IkimonoRegisterForm> {
  ...
  Future<void> _upload() async {
    ...
    try {
      ...
      await _onRegister(imageUrlResponse);
  ...
  Future<void> _onRegister(String imageUrl) async {
    ...
    try {
      await supabase.from('ikimono').insert(insertIkimono);
      if (mounted) context.showSnackBar('Successfully registered ikimono!');
